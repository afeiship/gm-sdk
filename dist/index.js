...
var i,r,o,s,c,a,u="object"==typeof t&&t&&t.Object===Object&&t,_="object"==typeof self&&self&&self.Object===Object&&self,f=u||_||Function("return this")(),h=e&&!e.nodeType&&e,p=h&&n&&!n.nodeType&&n,l=f.nx=f.nx||{BREAKER:{},VERSION:"2.6.0",DEBUG:!1,GLOBAL:f};
...
f.nx=l,i=Array.prototype,r=Object.prototype.hasOwnProperty,o=/\[(\w+)\]/g,l.noop=function(){},l.stubTrue=function(){return!0},l.stubFalse=function(){return!1},l.stubValue=function(t){return t},l.error=function(t){throw new Error(t)},l.try=function(t){try{t()}catch(t){}},l.forEach=function(t,n,e){var i,r=t.length;for(i=0;i<r&&n.call(e,t[i],i,t)!==l.BREAKER;i++);},l.forIn=function(t,n,e){var i;for(i in t)if(r.call(t,i)&&n.call(e,i,t[i],t)===l.BREAKER)break},l.each=function(t,n,e){var i,o,s=function(i,r,o){return n.call(e,i,r,t,o)===l.BREAKER};if(t)if("number"==typeof(o=t.length))for(i=0;i<o&&!s(i,t[i],!0);i++);else for(i in t)if(r.call(t,i)&&s(i,t[i],!1))break},l.map=function(t,n,e){var i=[];return l.each(t,(function(){var t=n.apply(e,arguments);if(t===l.BREAKER)return l.BREAKER;i.push(t)})),i},l.mix=function(t){var n,e,i=t||{},r=arguments;for(n=1,e=r.length;n<e;n++)l.forIn(r[n],(function(t,n){i[t]=n}));return i},l.slice=function(t,n,e){return i.slice.call(t,n,e)},l.set=function(t,n,e){for(var i=n.replace(o,"$1").split("."),r=t||l.GLOBAL,s=i.length-1,c=i[s],a=0;a<s;a++){var u=i[a],_=isNaN(+i[a+1])?{}:[];r=r[u]=r[u]||_}return r[c]=e,t},l.get=function(t,n,e){if(!n)return t;var i=n.replace(o,".$1").split("."),r=t||l.GLOBAL;return i.forEach((function(t){r=r&&r[t]})),void 0!==e&&null==r?e:r},l.path=function(t,n,e){return null==e?this.get(t,n):this.set(t,n,e)},s=function(){},c={__class_id__:0,__type__:"nx.RootClass",__base__:Object,__meta__:{},__static__:!1,__statics__:{},__properties__:{},__methods__:{},__method_init__:l.noop,__static_init__:l.noop},a={base:function(){var t,n=this.base.caller;if(n&&(t=n.__base__))return t.apply(this,arguments)},parent:function(t){var n=void 0===this.__id__,e=l.slice(arguments,1),i=n?this.__base__:this.__base__.prototype,r=this["@"+t].__type__,o=["get","set"][e.length];switch(r){case"method":return i[t].apply(this,e);case"property":return i["@"+t][o].apply(this,e)}}},c.__methods__=s.prototype=l.mix({constructor:s,init:l.noop,destroy:l.noop,toString:function(){return"[Class@"+this.__type__+"]"}},a),
//mix && export:
l.mix(c.__statics__,a),l.mix(s,c),l.mix(s,c.__statics__),l.RootClass=s,l.defineProperty=function(t,n,e,i){var r,o,s,c,a,u="@"+n,_=e&&"object"==typeof e?e:{value:e};return"value"in _?(c=_.value,a="_"+n,r=function(){return a in this?this[a]:"function"==typeof c?c.call(this):c},o=function(t){this[a]=t}):(r=e.get||t[u]&&t[u].get||l.noop,o=e.set||t[u]&&t[u].set||l.noop),
...
/*!
	 ...
	 * license: MIT
	 */
!function(){var n=n||this||window||Function("return this")(),i=n.nx||e,r=i.delete||_,o={method:"get"},s=["method","url","data"];i.parseRequestArgs=function(t,n){var e=t,c=null;
// input:
// 1. (config)
// 1. (url)
// 2. (url, config)
...
switch(e.length){case 1:c="string"==typeof e[0]?{url:e[0]}:e[0];break;case 2:c=i.mix({url:e[0]},e[1]);break;case 3:c=i.mix({method:e[0],url:e[1]},e[2]);break;case 4:c=i.mix({method:e[0],url:e[1],data:e[2]},e[3]);break;default:c=null,i.error("The arguments.length should between 1 ~ 4.")}return c=i.mix(null,o,c),n?[c.method,c.url,c.data,r(c,s)]:c},t.exports&&(t.exports=i.parseRequestArgs)}()})),h=n((function(t){
/*!
...
/*!
	 ...
	 * license: MIT
	 */
!function(){var n=n||this||window||Function("return this")(),i=n.nx||e;function r(t){return!0==(null!=(n=t)&&"object"==typeof n&&!1===Array.isArray(n))&&"[object Object]"===Object.prototype.toString.call(t);
// https://github.com/reduxjs/react-redux/blob/master/src/utils/isPlainObject.js
// https://github.com/jonschlinkert/is-plain-object
var n}i.isPlainObject=function(t){var n,e;return!(!t||"object"!=typeof t)&&(null===Object.getPrototypeOf(t)||!1!==r(t)&&("function"==typeof(
